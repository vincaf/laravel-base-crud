            ...
            <div class="col-10">
                ...
                <form action="{{ route('works.update', $work->slug) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="input-title" name="title" value="{{ old('title', $work->title) }}" required>
                        @error('title')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="input-thumb" name="thumb" value="{{ old('thumb', $work->thumb) }}" required>
                        @error('thumb')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="input-price" name="price" value="{{ old('price', $work->price) }}" required>
                        @error('price')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="input-series" name="series" value="{{ old('series', $work->series) }}" required>
                        @error('series')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="input-sale_date" name="sale_date" value="{{ old('sale_date', $work->sale_date) }}" required>
                        @error('sale_date')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
